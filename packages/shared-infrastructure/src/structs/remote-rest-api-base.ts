...
export class RemoteRestAPIBase extends ScopedPresenceAdapter {
  /**
  ...
  sessionExpiryMS = RemoteRestAPIBase.DEFAULT_EXPIRY_MS;
  api: RESTPresenceAPI;
   ...
   * @param user user ID
   */
  createSession(user: string | typeof FIRST_PARTY_SCOPE): string {
