...
import { SearchResult, User } from "@presenti/shared-db";
import { AdminGuard, AJVGuard, BodyParser, Delete, Get, Patch, PBRequest, PBResponse, Put, RequestHandler, UserLoader, RestAPIBase } from "@presenti/web";
...
export class RestAdminAPI extends RestAPIBase {
    @Get("/users/search")
