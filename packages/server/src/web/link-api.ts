import { FirstPartyGuard, Patch, PBRequest, PBResponse, Delete, BodyParser, Post, Get, UserLoader, RestAPIBase } from "@presenti/web";
import { API, GlobalGuards } from "@presenti/modules";
import { PipeDirection, APIError } from "@presenti/utils";
...
export class RestLinkAPI extends RestAPIBase {
