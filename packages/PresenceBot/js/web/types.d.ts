...
export declare type HTTPMethod = keyof Omit<TemplatedApp, 'listen' | 'publish' | 'ws'>;
export declare type RequestHandler = (req: PBRequest, res: PBResponse, next: (stop?: boolean) => any, err: (e: any) => any) => any;
