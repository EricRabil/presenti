...
const DenyFirstParties = (req, res, next) => {
    ...
    if (((_a = adapter.sessionIndex) === null || _a === void 0 ? void 0 : _a.sessionID) === socket_api_adapter_1.FIRST_PARTY_SCOPE) {
...
class RESTPresenceAPI extends rest_api_base_1.default {
    constructor(app, adapter) {
        ...
        this.log = utils_1.log.child({ name: "RESTPresenceAPI" });
    }
    ...
    async updateSession(req, res) {
        ...
        res.adapter.presenceLedger[res.sessionID][res.adapter.sessionIndex[res.sessionID]] = req.body.presences;
        res.json({ ok: true });
    }
...
class RESTAdapterV2 extends scoped_adapter_1.ScopedPresenceAdapter {
    constructor(app) {
        ...
        this.log = utils_1.log.child({ name: "RestAdapterV2" });
    ...
    sessionCanUpdateScope(sessionID, scope) {
        return this.sessionIndex[sessionID] === scope || this.sessionIndex[sessionID] === socket_api_adapter_1.FIRST_PARTY_SCOPE;
    }
