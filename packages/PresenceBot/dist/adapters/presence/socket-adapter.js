...
class RemoteAdatpterV2 extends socket_api_base_1.SocketAPIAdapter {
    constructor(app) {
        super(app, '/remote');
        this.log = logging_1.log.child({ name: "RemoteAdapterV2" });
...
__decorate([
    socket_api_base_1.Handler(remote_presence_utils_1.PayloadType.PRESENCE),
    socket_api_base_1.DenyFirstParty(),
    socket_api_base_1.Authed(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_api_base_1.SocketContext, Object]),
    __metadata("design:returntype", void 0)
], RemoteAdatpterV2.prototype, "presenceHandler", null);
__decorate([
    socket_api_base_1.Handler(remote_presence_utils_1.PayloadType.PRESENCE_FIRST_PARTY),
    socket_api_base_1.FirstParty(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_api_base_1.SocketContext, Object]),
    __metadata("design:returntype", void 0)
], RemoteAdatpterV2.prototype, "firstPartyPresenceHandler", null);
__decorate([
    socket_api_base_1.Handler(remote_presence_utils_1.PayloadType.IDENTIFY),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_api_base_1.SocketContext, Object]),
